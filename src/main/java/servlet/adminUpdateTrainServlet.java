...
/**
 * Servlet implementation class adminUpdateTrainServlet
 */
@WebServlet("/adminUpdateTrainServlet")
public class adminUpdateTrainServlet extends HttpServlet {
		...
		TrainUtil.validateUserAuthorization(request, userRole.ADMIN);
			...
			try {
				...
				if(trains != null && !trains.isEmpty()){
					...
					response.sendRedirect("adminupdatetrain.jsp");
